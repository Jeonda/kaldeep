from flask import Flask, render_template_string, Response #jdh 
...
def frame_generator():
  while True:
      ...
      if (rawImage == None):
          ...
          png_2 = cv2.imdecode(airsim.string_to_uint8_array(rawImage), cv2.IMREAD_UNCHANGED)
          cv2.putText(png_2,'Koreanair ' + str(fps),textOrg, fontFace, fontScale,(255,0,255),thickness)
